                ...
                var scaleSettings = azure.AutoscaleSettings.Define(autoscaleSettingsName)
                        ...
                        .DefineAutoscaleProfile("Monday to Friday")
                            ...
                            .DefineScaleRule()
                                ...
                                .WithStatistic(TimeSpan.FromMinutes(5), TimeSpan.FromMinutes(1), MetricStatisticType.Sum)
                                .WithCondition(ComparisonOperationType.GreaterThan, TimeAggregationType.Total, 10)
                            ...
                            .DefineScaleRule()
                                ...
                                .WithCondition(ComparisonOperationType.LessThan, TimeAggregationType.Total, 5)
