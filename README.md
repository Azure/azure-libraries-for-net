...
This README is based on the released stable version (1.22.2). If you are looking for other releases, see [More Information](#more-information)
...
:triangular_flag_on_post: *as of Version 1.22.2*
...
**1.22.2** release builds are available on NuGet:
...
If you are migrating your code from 1.22.x to 1.22.2, you can use these release notes for [preparing your code for 1.22.2 from 1.22.0](./notes/prepare-for-1.22.2.md).
