...
This README is based on the released stable version (1.19). If you are looking for other releases, see [More Information](#more-information)
...
:triangular_flag_on_post: *as of Version 1.19.0*
...
**1.19** release builds are available on NuGet:
...
If you are migrating your code from 1.18.x to 1.19.x, you can use these release notes for [preparing your code for 1.19 from 1.18](./notes/prepare-for-1.19.md).
