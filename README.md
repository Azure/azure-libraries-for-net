...
This README is based on the released stable version (1.28). If you are looking for other releases, see [More Information](#more-information)
...
:triangular_flag_on_post: *as of Version 1.28*
...
**1.28** release builds are available on NuGet:
...
|-------------------|-------------------------------------------------------------------------------------------|-------------------------------------------------------|
| 1.28              | [1.28](https://github.com/Azure/azure-libraries-for-net/releases/tag/Fluent-v1.28)      | Tagged release for 1.28 version of Azure management libraries |
