...
namespace Microsoft.Azure.Management.Batch.Fluent
{
    ...
    internal partial class CertificateOperations : IServiceOperations<BatchManagementClient>, ICertificateOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<CertificateInner>>> ListByBatchAccountWithHttpMessagesAsync(string resourceGroupName, string accountName, int? maxresults = default(int?), string select = default(string), string filter = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<CertificateInner>>> ListByBatchAccountNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
