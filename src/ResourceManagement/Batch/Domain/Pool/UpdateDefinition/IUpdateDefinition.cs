...
namespace Microsoft.Azure.Management.Batch.Fluent.Pool.UpdateDefinition
{
    ...
    /// <summary>
    /// The final stage of a Batch pool definition.
    /// At this stage, any optional settings can be specified for the pool definition
        ...
        ResourceManager.Fluent.Core.ChildResource.Update.IInUpdate<ParentT>
    {
        ...
        /// <return>The next stage of the definition.</return>
        IWithAttach<ParentT> WithMountConfiguration(MountConfiguration mountConfiguration);
