...
namespace Microsoft.Azure.Management.BatchAI.Fluent.Models
{
    ...
    /// </summary>
    public partial class FileServersListOptionsInner
    {
        /// <summary>
        /// Initializes a new instance of the FileServersListOptionsInner
        /// class.
        /// </summary>
        public FileServersListOptionsInner()
        {
            CustomInit();
        }
        ...
        public FileServersListOptionsInner(string filter = default(string), string select = default(string), int? maxResults = default(int?))
        {
            Filter = filter;
            Select = select;
