...
namespace Microsoft.Azure.Management.BatchAI.Fluent.Models
{
    ...
    /// </summary>
    public partial class FileServersListByResourceGroupOptionsInner
    {
        /// <summary>
        /// Initializes a new instance of the
        /// FileServersListByResourceGroupOptionsInner class.
        /// </summary>
        public FileServersListByResourceGroupOptionsInner()
        {
            CustomInit();
        }
        ...
        public FileServersListByResourceGroupOptionsInner(string filter = default(string), string select = default(string), int? maxResults = default(int?))
        {
            Filter = filter;
            Select = select;
