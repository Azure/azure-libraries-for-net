...
namespace Microsoft.Azure.Management.BatchAI.Fluent.Models
{
    ...
    /// </summary>
    public partial class ClustersListOptionsInner
    {
        /// <summary>
        /// Initializes a new instance of the ClustersListOptionsInner class.
        /// </summary>
        public ClustersListOptionsInner()
        {
          CustomInit();
        }
        ...
        public ClustersListOptionsInner(string filter = default(string), string select = default(string), int? maxResults = default(int?))
        {
            Filter = filter;
            Select = select;
