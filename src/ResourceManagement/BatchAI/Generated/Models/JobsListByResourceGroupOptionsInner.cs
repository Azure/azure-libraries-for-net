...
namespace Microsoft.Azure.Management.BatchAI.Fluent.Models
{
    ...
    /// </summary>
    public partial class JobsListByResourceGroupOptionsInner
    {
        /// <summary>
        /// Initializes a new instance of the
        /// JobsListByResourceGroupOptionsInner class.
        /// </summary>
        public JobsListByResourceGroupOptionsInner()
        {
            CustomInit();
        }
        ...
        public JobsListByResourceGroupOptionsInner(string filter = default(string), string select = default(string), int? maxResults = default(int?))
        {
            Filter = filter;
            Select = select;
