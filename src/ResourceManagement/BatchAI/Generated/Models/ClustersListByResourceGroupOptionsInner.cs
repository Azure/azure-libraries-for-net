...
namespace Microsoft.Azure.Management.BatchAI.Fluent.Models
{
    ...
    /// </summary>
    public partial class ClustersListByResourceGroupOptionsInner
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ClustersListByResourceGroupOptionsInner class.
        /// </summary>
        public ClustersListByResourceGroupOptionsInner()
        {
          CustomInit();
        }
        ...
        public ClustersListByResourceGroupOptionsInner(string filter = default(string), string select = default(string), int? maxResults = default(int?))
        {
            Filter = filter;
            Select = select;
