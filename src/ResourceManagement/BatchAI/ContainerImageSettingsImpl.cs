...
///GENTHASH:Y29tLm1pY3Jvc29mdC5henVyZS5tYW5hZ2VtZW50LmJhdGNoYWkuaW1wbGVtZW50YXRpb24uQ29udGFpbmVySW1hZ2VTZXR0aW5nc0ltcGw=
    internal partial class ContainerImageSettingsImpl  :
        IndexableWrapper<Microsoft.Azure.Management.BatchAI.Fluent.Models.ImageSourceRegistry>,
        IDefinition<BatchAIJob.Definition.IWithCreate>
    {
        ...
        protected  ContainerImageSettingsImpl(ImageSourceRegistry inner, BatchAIJobImpl parent) : base(inner)
        {
            this.parent = parent;
        }
        ...
        {
            Inner.Credentials = new PrivateRegistryCredentials(username);
            return this;
        }
    }
}