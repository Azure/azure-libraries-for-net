...
namespace Microsoft.Azure.Management.BatchAI.Fluent
{
    ...
    public partial class BatchAIJobImpl 
    {
        ...
        async Task<Microsoft.Azure.Management.BatchAI.Fluent.IOutputFile> Microsoft.Azure.Management.BatchAI.Fluent.IBatchAIJob.ListFilesAsync(string outputDirectoryId, CancellationToken cancellationToken)
        {
            return await this.ListFilesAsync(outputDirectoryId, cancellationToken) as Microsoft.Azure.Management.BatchAI.Fluent.IOutputFile;
        }
