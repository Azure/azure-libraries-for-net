...
namespace Microsoft.Azure.Management.ResourceManager.Fluent.Models
{
    ...
    public partial class SubscriptionInner
    {
        ...
        /// RoleBased'.</param>
        public SubscriptionInner(string id = default(string), string subscriptionId = default(string), string displayName = default(string), SubscriptionState? state = default(SubscriptionState?), SubscriptionPolicies subscriptionPolicies = default(SubscriptionPolicies), string authorizationSource = default(string))
        {
            Id = id;
