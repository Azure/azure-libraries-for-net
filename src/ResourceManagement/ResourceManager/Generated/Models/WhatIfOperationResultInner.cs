...
namespace Microsoft.Azure.Management.ResourceManager.Fluent.Models
{
    ...
    public partial class WhatIfOperationResultInner
    {
        /// <summary>
        ...
        public WhatIfOperationResultInner(string status = default(string), IList<WhatIfChange> changes = default(IList<WhatIfChange>), ErrorResponse error = default(ErrorResponse))
        {
            Status = status;
            Changes = changes;
            Error = error;
