...
namespace Microsoft.Azure.Management.ResourceManager.Fluent
{
    ...
    public static partial class ProviderResourceTypesOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<ProviderResourceTypeListResultInner> ListAsync(this IProviderResourceTypesOperations operations, string resourceProviderNamespace, string expand = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
