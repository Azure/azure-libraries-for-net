...
namespace Microsoft.Azure.Management.ResourceManager.Fluent
{
    ...
    internal partial class ProviderResourceTypesOperations : IServiceOperations<ResourceManagementClient>, IProviderResourceTypesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ProviderResourceTypeListResultInner>> ListWithHttpMessagesAsync(string resourceProviderNamespace, string expand = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<ProviderResourceTypeListResultInner>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ProviderResourceTypeListResultInner>(_responseContent, Client.DeserializationSettings);
                }
