...
namespace Microsoft.Azure.Management.KeyVault.Fluent.AccessPolicy.UpdateDefinition
{
    ...
    public interface IWithPermissions<ParentT> 
    {
        ...
        /// <return>The next stage of access policy definition.</return>
        Microsoft.Azure.Management.KeyVault.Fluent.AccessPolicy.UpdateDefinition.IWithAttach<ParentT> AllowKeyPermissions(params KeyPermissions[] permissions);
        ...
        /// <param name="permissions">The list of permissions allowed.</param>
        /// <return>The next stage of access policy definition.</return>
        Microsoft.Azure.Management.KeyVault.Fluent.AccessPolicy.UpdateDefinition.IWithAttach<ParentT> AllowSecretPermissions(params SecretPermissions[] permissions);
