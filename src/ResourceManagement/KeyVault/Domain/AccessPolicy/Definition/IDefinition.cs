...
namespace Microsoft.Azure.Management.KeyVault.Fluent.AccessPolicy.Definition
{
    ...
    public interface IWithPermissions<ParentT> 
    {
        ...
        /// <param name="permissions">The list of permissions allowed.</param>
        /// <return>The next stage of access policy definition.</return>
        Microsoft.Azure.Management.KeyVault.Fluent.AccessPolicy.Definition.IWithAttach<ParentT> AllowKeyPermissions(params KeyPermissions[] permissions);
        ...
        /// <param name="permissions">The list of permissions allowed.</param>
        /// <return>The next stage of access policy definition.</return>
        Microsoft.Azure.Management.KeyVault.Fluent.AccessPolicy.Definition.IWithAttach<ParentT> AllowSecretPermissions(params SecretPermissions[] permissions);
