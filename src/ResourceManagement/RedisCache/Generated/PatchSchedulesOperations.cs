...
namespace Microsoft.Azure.Management.Redis.Fluent
{
    ...
    internal partial class PatchSchedulesOperations : IServiceOperations<RedisManagementClient>, IPatchSchedulesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<RedisPatchScheduleInner>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string name, IList<ScheduleEntryInner> scheduleEntriesProperty, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (scheduleEntriesProperty != null)
            {
                parameters.ScheduleEntriesProperty = scheduleEntriesProperty;
            }
            // Tracing
