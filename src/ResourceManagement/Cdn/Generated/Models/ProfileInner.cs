...
namespace Microsoft.Azure.Management.Cdn.Fluent.Models
{
    ...
    public partial class ProfileInner : Microsoft.Azure.Management.ResourceManager.Fluent.Resource
    {
        ...
        /// profile.</param>
        public ProfileInner(Sku sku, string location = default(string), string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string resourceState = default(string), string provisioningState = default(string))
