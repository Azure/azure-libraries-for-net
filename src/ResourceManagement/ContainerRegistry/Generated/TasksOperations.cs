...
namespace Microsoft.Azure.Management.ContainerRegistry.Fluent
{
    ...
    internal partial class TasksOperations : IServiceOperations<ContainerRegistryManagementClient>, ITasksOperations
    {
        ...
        /// </return>
        public async System.Threading.Tasks.Task<AzureOperationResponse<IPage<TaskInner>>> ListWithHttpMessagesAsync(string resourceGroupName, string registryName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<TaskInner>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<TaskInner>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async System.Threading.Tasks.Task<AzureOperationResponse<TaskInner>> GetWithHttpMessagesAsync(string resourceGroupName, string registryName, string taskName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
            ...
            // Create Result
            var _result = new AzureOperationResponse<TaskInner>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<TaskInner>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// The cancellation token.
        /// </param>
        public async System.Threading.Tasks.Task<AzureOperationResponse<TaskInner>> CreateWithHttpMessagesAsync(string resourceGroupName, string registryName, string taskName, TaskInner taskCreateParameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send Request
            AzureOperationResponse<TaskInner> _response = await BeginCreateWithHttpMessagesAsync(resourceGroupName, registryName, taskName, taskCreateParameters, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        /// The cancellation token.
        /// </param>
        public async System.Threading.Tasks.Task<AzureOperationResponse<TaskInner>> UpdateWithHttpMessagesAsync(string resourceGroupName, string registryName, string taskName, TaskUpdateParametersInner taskUpdateParameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send Request
            AzureOperationResponse<TaskInner> _response = await BeginUpdateWithHttpMessagesAsync(resourceGroupName, registryName, taskName, taskUpdateParameters, customHeaders, cancellationToken).ConfigureAwait(false);
            return await Client.GetPutOrPatchOperationResultAsync(_response, customHeaders, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async System.Threading.Tasks.Task<AzureOperationResponse<TaskInner>> GetDetailsWithHttpMessagesAsync(string resourceGroupName, string registryName, string taskName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async System.Threading.Tasks.Task<AzureOperationResponse<TaskInner>> BeginCreateWithHttpMessagesAsync(string resourceGroupName, string registryName, string taskName, TaskInner taskCreateParameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async System.Threading.Tasks.Task<AzureOperationResponse<IPage<TaskInner>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
