...
namespace Microsoft.Azure.Management.ContainerRegistry.Fluent.Models
{
    ...
    /// </summary>
    public partial class QuarantinePolicyInner
    {
        /// <summary>
        /// Initializes a new instance of the QuarantinePolicyInner class.
        /// </summary>
        public QuarantinePolicyInner()
        {
            CustomInit();
        }
        ...
        /// 'disabled'</param>
        public QuarantinePolicyInner(string status = default(string))
        {
            Status = status;
            CustomInit();
        }
