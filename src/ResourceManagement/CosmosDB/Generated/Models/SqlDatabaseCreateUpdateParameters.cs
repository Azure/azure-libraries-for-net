...
namespace Microsoft.Azure.Management.CosmosDB.Fluent.Models
{
    ...
    public partial class SqlDatabaseCreateUpdateParameters : ARMResourcePropertiesInner
    {
        ...
        /// request.</param>
        public SqlDatabaseCreateUpdateParameters(string location, SqlDatabaseResource resource, CreateUpdateOptions options, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
