...
namespace Microsoft.Azure.Management.CosmosDB.Fluent.Models
{
    ...
    public partial class MongoDBCollectionGetResultsInner : ARMResourcePropertiesInner
    {
        /// <summary>
        /// Initializes a new instance of the MongoDBCollectionGetResultsInner
        /// class.
        /// </summary>
        ...
        public MongoDBCollectionGetResultsInner(string location, string mongoDBCollectionGetResultsId, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), IDictionary<string, string> shardKey = default(IDictionary<string, string>), IList<MongoIndex> indexes = default(IList<MongoIndex>), string _rid = default(string), object _ts = default(object), string _etag = default(string))
