...
namespace Microsoft.Azure.Management.CosmosDB.Fluent.Models
{
    ...
    public partial class SqlContainerCreateUpdateParameters : ARMResourcePropertiesInner
    {
        ...
        /// request.</param>
        public SqlContainerCreateUpdateParameters(string location, SqlContainerResource resource, CreateUpdateOptions options, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
