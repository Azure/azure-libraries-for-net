...
namespace Microsoft.Azure.Management.CosmosDB.Fluent.Models
{
    ...
    public partial class MongoDBDatabaseCreateUpdateParameters : ARMResourcePropertiesInner
    {
        /// <summary>
        ...
        /// request.</param>
        public MongoDBDatabaseCreateUpdateParameters(string location, MongoDBDatabaseResource resource, IDictionary<string, string> options, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
