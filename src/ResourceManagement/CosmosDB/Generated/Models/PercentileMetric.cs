...
namespace Microsoft.Azure.Management.CosmosDB.Fluent.Models
{
    ...
    public partial class PercentileMetric
    {
        ...
        public PercentileMetric(System.DateTime? startTime = default(System.DateTime?), System.DateTime? endTime = default(System.DateTime?), string timeGrain = default(string), UnitType unit = default(UnitType), MetricName name = default(MetricName), IList<PercentileMetricValue> metricValues = default(IList<PercentileMetricValue>))
        {
            StartTime = startTime;
            EndTime = endTime;
            TimeGrain = timeGrain;
