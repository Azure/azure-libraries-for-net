...
namespace Microsoft.Azure.Management.CosmosDB.Fluent.Models
{
    ...
    public partial class GremlinGraphCreateUpdateParameters : ARMResourcePropertiesInner
    {
        /// <summary>
        ...
        /// request.</param>
        public GremlinGraphCreateUpdateParameters(string location, GremlinGraphResource resource, IDictionary<string, string> options, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
