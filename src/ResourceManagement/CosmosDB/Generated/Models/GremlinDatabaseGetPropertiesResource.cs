...
namespace Microsoft.Azure.Management.CosmosDB.Fluent.Models
{
    ...
    public partial class GremlinDatabaseGetPropertiesResource
    {
        ...
        /// GremlinDatabaseGetPropertiesResource class.
        /// </summary>
        ...
        public GremlinDatabaseGetPropertiesResource(string id, string _rid = default(string), object _ts = default(object), string _etag = default(string))
        {
            Id = id;
            this._rid = _rid;
            this._ts = _ts;
