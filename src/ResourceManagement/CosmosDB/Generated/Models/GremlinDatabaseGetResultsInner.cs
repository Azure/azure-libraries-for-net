...
namespace Microsoft.Azure.Management.CosmosDB.Fluent.Models
{
    ...
    public partial class GremlinDatabaseGetResultsInner : ARMResourcePropertiesInner
    {
        /// <summary>
        /// Initializes a new instance of the GremlinDatabaseGetResultsInner
        /// class.
        /// </summary>
        ...
        public GremlinDatabaseGetResultsInner(string location, string gremlinDatabaseGetResultsId, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string _rid = default(string), object _ts = default(object), string _etag = default(string))
