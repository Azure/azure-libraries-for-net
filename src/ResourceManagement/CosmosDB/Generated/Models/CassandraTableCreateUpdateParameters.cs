...
namespace Microsoft.Azure.Management.CosmosDB.Fluent.Models
{
    ...
    public partial class CassandraTableCreateUpdateParameters : ARMResourcePropertiesInner
    {
        ...
        /// request.</param>
        public CassandraTableCreateUpdateParameters(string location, CassandraTableResource resource, CreateUpdateOptions options, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
