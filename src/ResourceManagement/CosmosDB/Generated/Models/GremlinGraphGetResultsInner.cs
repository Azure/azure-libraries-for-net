...
namespace Microsoft.Azure.Management.CosmosDB.Fluent.Models
{
    ...
    public partial class GremlinGraphGetResultsInner : ARMResourcePropertiesInner
    {
        ...
        /// class.
        /// </summary>
        public GremlinGraphGetResultsInner(string location, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), GremlinGraphGetPropertiesResource resource = default(GremlinGraphGetPropertiesResource))
