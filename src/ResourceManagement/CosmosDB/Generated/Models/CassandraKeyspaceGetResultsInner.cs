...
namespace Microsoft.Azure.Management.CosmosDB.Fluent.Models
{
    ...
    public partial class CassandraKeyspaceGetResultsInner : ARMResourcePropertiesInner
    {
        ...
        /// class.
        /// </summary>
        public CassandraKeyspaceGetResultsInner(string location, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), CassandraKeyspaceGetPropertiesResource resource = default(CassandraKeyspaceGetPropertiesResource))
