...
namespace Microsoft.Azure.Management.CosmosDB.Fluent.Models
{
    ...
    public partial class SqlUserDefinedFunctionCreateUpdateParameters : ARMResourcePropertiesInner
    {
        ...
        /// request.</param>
        public SqlUserDefinedFunctionCreateUpdateParameters(string location, SqlUserDefinedFunctionResource resource, IDictionary<string, string> options, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
