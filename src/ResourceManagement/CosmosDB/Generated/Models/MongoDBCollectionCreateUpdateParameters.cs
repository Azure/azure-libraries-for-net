...
namespace Microsoft.Azure.Management.CosmosDB.Fluent.Models
{
    ...
    public partial class MongoDBCollectionCreateUpdateParameters : ARMResourcePropertiesInner
    {
        ...
        /// request.</param>
        public MongoDBCollectionCreateUpdateParameters(string location, MongoDBCollectionResource resource, IDictionary<string, string> options, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
