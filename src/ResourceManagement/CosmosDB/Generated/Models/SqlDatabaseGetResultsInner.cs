...
namespace Microsoft.Azure.Management.CosmosDB.Fluent.Models
{
    ...
    public partial class SqlDatabaseGetResultsInner : ARMResourcePropertiesInner
    {
        ...
        /// Initializes a new instance of the SqlDatabaseGetResultsInner class.
        /// </summary>
        public SqlDatabaseGetResultsInner(string location, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), SqlDatabaseGetPropertiesResource resource = default(SqlDatabaseGetPropertiesResource))
