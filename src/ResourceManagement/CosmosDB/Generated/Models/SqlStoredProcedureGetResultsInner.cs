...
namespace Microsoft.Azure.Management.CosmosDB.Fluent.Models
{
    ...
    public partial class SqlStoredProcedureGetResultsInner : ARMResourcePropertiesInner
    {
        ...
        /// class.
        /// </summary>
        public SqlStoredProcedureGetResultsInner(string location, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), SqlStoredProcedureGetPropertiesResource resource = default(SqlStoredProcedureGetPropertiesResource))
