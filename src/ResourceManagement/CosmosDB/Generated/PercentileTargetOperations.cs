...
namespace Microsoft.Azure.Management.CosmosDB.Fluent
{
    ...
    /// </summary>
    internal partial class PercentileTargetOperations : IServiceOperations<CosmosDB>, IPercentileTargetOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal PercentileTargetOperations(CosmosDB client)
        {
            if (client == null)
            {
