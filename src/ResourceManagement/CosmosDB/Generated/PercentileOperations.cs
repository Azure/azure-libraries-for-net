...
namespace Microsoft.Azure.Management.CosmosDB.Fluent
{
    ...
    /// </summary>
    internal partial class PercentileOperations : IServiceOperations<CosmosDB>, IPercentileOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal PercentileOperations(CosmosDB client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<PercentileMetric>>> ListMetricsWithHttpMessagesAsync(string resourceGroupName, string accountName, string filter, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
