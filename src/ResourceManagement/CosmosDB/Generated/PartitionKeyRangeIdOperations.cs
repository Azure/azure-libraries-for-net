...
namespace Microsoft.Azure.Management.CosmosDB.Fluent
{
    ...
    /// </summary>
    internal partial class PartitionKeyRangeIdOperations : IServiceOperations<CosmosDB>, IPartitionKeyRangeIdOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal PartitionKeyRangeIdOperations(CosmosDB client)
        {
            if (client == null)
            {
