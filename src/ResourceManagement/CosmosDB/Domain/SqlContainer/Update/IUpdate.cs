...
namespace Microsoft.Azure.Management.CosmosDB.Fluent.SqlContainer.Update
{
    ...
    public interface IWithChildResource
    {
        ...
        /// <param name="options">The options for the store procedure.</param>
        /// <returns>The next stage of the update.</returns>
        IUpdate WithStoredProcedure(string name, string body, IDictionary<string, string> options = default);
        ...
        /// <param name="options">The options for the user defined function.</param>
        /// <returns>The next stage of the update.</returns>
        IUpdate WithUserDefinedFunction(string name, string body, IDictionary<string, string> options = default);
        ...
        /// <param name="options">The options for the trigger.</param>
        /// <returns>The next stage of the update.</returns>
        IUpdate WithTrigger(string name, string body, Models.TriggerType triggerType, Models.TriggerOperation triggerOperation, IDictionary<string, string> options = default);
