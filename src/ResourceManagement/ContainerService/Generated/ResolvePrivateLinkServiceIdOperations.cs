...
namespace Microsoft.Azure.Management.ContainerService.Fluent
{
    ...
    /// </summary>
    internal partial class ResolvePrivateLinkServiceIdOperations : IServiceOperations<ContainerServiceManagementClient>, IResolvePrivateLinkServiceIdOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal ResolvePrivateLinkServiceIdOperations(ContainerServiceManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<PrivateLinkResourceInner>> POSTWithHttpMessagesAsync(string resourceGroupName, string resourceName, PrivateLinkResourceInner parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
