...
namespace Microsoft.Azure.Management.ContainerService.Fluent
{
    ...
    public static partial class PrivateEndpointConnectionsOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<PrivateEndpointConnectionListResultInner> ListAsync(this IPrivateEndpointConnectionsOperations operations, string resourceGroupName, string resourceName, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<PrivateEndpointConnectionInner> GetAsync(this IPrivateEndpointConnectionsOperations operations, string resourceGroupName, string resourceName, string privateEndpointConnectionName, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<PrivateEndpointConnectionInner> UpdateAsync(this IPrivateEndpointConnectionsOperations operations, string resourceGroupName, string resourceName, string privateEndpointConnectionName, PrivateEndpointConnectionInner parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
