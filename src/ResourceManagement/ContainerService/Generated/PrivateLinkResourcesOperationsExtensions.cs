...
namespace Microsoft.Azure.Management.ContainerService.Fluent
{
    ...
    public static partial class PrivateLinkResourcesOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<PrivateLinkResourcesListResultInner> ListAsync(this IPrivateLinkResourcesOperations operations, string resourceGroupName, string resourceName, CancellationToken cancellationToken = default(CancellationToken))
            {
