...
namespace Microsoft.Azure.Management.ContainerService.Fluent
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<ContainerServiceManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(ContainerServiceManagementClient client)
        {
            if (client == null)
            {
