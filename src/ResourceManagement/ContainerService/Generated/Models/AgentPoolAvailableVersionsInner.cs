...
namespace Microsoft.Azure.Management.ContainerService.Fluent.Models
{
    ...
    public partial class AgentPoolAvailableVersionsInner
    {
        /// <summary>
        /// Initializes a new instance of the AgentPoolAvailableVersionsInner
        /// class.
        /// </summary>
        ...
        /// agent pool.</param>
        public AgentPoolAvailableVersionsInner(string id = default(string), string name = default(string), string type = default(string), IList<AgentPoolAvailableVersionsPropertiesAgentPoolVersionsItem> agentPoolVersions = default(IList<AgentPoolAvailableVersionsPropertiesAgentPoolVersionsItem>))
        {
            Id = id;
            Name = name;
            Type = type;
