...
namespace Microsoft.Azure.Management.ContainerService.Fluent
{
    ...
    /// </summary>
    internal partial class PrivateLinkResourcesOperations : IServiceOperations<ContainerServiceManagementClient>, IPrivateLinkResourcesOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal PrivateLinkResourcesOperations(ContainerServiceManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<PrivateLinkResourcesListResultInner>> ListWithHttpMessagesAsync(string resourceGroupName, string resourceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<PrivateLinkResourcesListResultInner>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<PrivateLinkResourcesListResultInner>(_responseContent, Client.DeserializationSettings);
                }
