...
namespace Microsoft.Azure.Management.TrafficManager.Fluent
{
    ...
    public partial interface IHeatMapOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<HeatMapModelInner>> GetWithHttpMessagesAsync(string resourceGroupName, string profileName, IList<double?> topLeft = default(IList<double?>), IList<double?> botRight = default(IList<double?>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
