    ...
    internal partial class VirtualMachineExtensionImagesOperations : IServiceOperations<ComputeManagementClient>, IVirtualMachineExtensionImagesOperations
    {
        ...
        public async Task<AzureOperationResponse<VirtualMachineExtensionImageInner>> GetWithHttpMessagesAsync(string location, string publisherName, string type, string version, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<VirtualMachineExtensionImageInner>(_responseContent, Client.DeserializationSettings);
                }
        ...
        public async Task<AzureOperationResponse<IList<VirtualMachineExtensionImageInner>>> ListTypesWithHttpMessagesAsync(string location, string publisherName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<IList<VirtualMachineExtensionImageInner>>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
