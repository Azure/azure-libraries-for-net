...
namespace Microsoft.Azure.Management.Compute.Fluent.Models
{
    ...
    public partial class AvailabilitySetUpdateInner : UpdateResource
    {
        ...
        public AvailabilitySetUpdateInner(IDictionary<string, string> tags = default(IDictionary<string, string>), int? platformUpdateDomainCount = default(int?), int? platformFaultDomainCount = default(int?), IList<ResourceManager.Fluent.SubResource> virtualMachines = default(IList<ResourceManager.Fluent.SubResource>), IList<InstanceViewStatus> statuses = default(IList<InstanceViewStatus>), Sku sku = default(Sku))
            : base(tags)
        {
        ...
        public IList<ResourceManager.Fluent.SubResource> VirtualMachines { get; set; }
