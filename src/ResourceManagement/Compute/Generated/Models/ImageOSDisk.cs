...
namespace Microsoft.Azure.Management.Compute.Fluent.Models
{
    ...
    public partial class ImageOSDisk
    {
        ...
        public ImageOSDisk(OperatingSystemTypes osType, OperatingSystemStateTypes osState, Rest.Azure.SubResource snapshot = default(Rest.Azure.SubResource), Rest.Azure.SubResource managedDisk = default(Rest.Azure.SubResource), string blobUri = default(string), CachingTypes? caching = default(CachingTypes?), int? diskSizeGB = default(int?), string storageAccountType = default(string))
        {
            OsType = osType;
            OsState = osState;
            Snapshot = snapshot;
