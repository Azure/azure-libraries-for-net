...
namespace Microsoft.Azure.Management.Compute.Fluent.Models
{
    ...
    public partial class VirtualMachineRunCommandInstanceView
    {
        ...
        public VirtualMachineRunCommandInstanceView(ExecutionState executionState = default(ExecutionState), string executionMessage = default(string), int? exitCode = default(int?), string output = default(string), string error = default(string), System.DateTime? startTime = default(System.DateTime?), System.DateTime? endTime = default(System.DateTime?), IList<InstanceViewStatus> statuses = default(IList<InstanceViewStatus>))
        {
