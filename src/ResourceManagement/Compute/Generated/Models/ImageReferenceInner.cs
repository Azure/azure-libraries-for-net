...
namespace Microsoft.Azure.Management.Compute.Fluent.Models
{
    ...
    public partial class ImageReferenceInner : Management.ResourceManager.Fluent.SubResource
    {
        ...
        public ImageReferenceInner(string id = default(string), string publisher = default(string), string offer = default(string), string sku = default(string), string version = default(string), string exactVersion = default(string))
            : base(id)
        {
            Publisher = publisher;
            Offer = offer;
