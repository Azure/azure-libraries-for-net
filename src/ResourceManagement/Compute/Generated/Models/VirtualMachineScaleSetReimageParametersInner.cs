...
namespace Microsoft.Azure.Management.Compute.Fluent.Models
{
    ...
    /// </summary>
    public partial class VirtualMachineScaleSetReimageParametersInner : VirtualMachineScaleSetVMReimageParameters
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VirtualMachineScaleSetReimageParametersInner class.
        /// </summary>
        public VirtualMachineScaleSetReimageParametersInner()
        {
            CustomInit();
        }
        ...
        public VirtualMachineScaleSetReimageParametersInner(bool? tempDisk = default(bool?), IList<string> instanceIds = default(IList<string>))
            : base(tempDisk)
        {
