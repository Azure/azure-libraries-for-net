...
namespace Microsoft.Azure.Management.Compute.Fluent.Models
{
    ...
    public partial class VirtualMachineSoftwarePatchProperties
    {
        ...
        public VirtualMachineSoftwarePatchProperties(string patchId = default(string), string name = default(string), string version = default(string), string kbid = default(string), IList<string> classifications = default(IList<string>), SoftwareUpdateRebootBehavior rebootBehavior = default(SoftwareUpdateRebootBehavior), string activityId = default(string), System.DateTime? publishedDate = default(System.DateTime?), System.DateTime? lastModifiedDateTime = default(System.DateTime?), PatchAssessmentState assessmentState = default(PatchAssessmentState))
        {
            PatchId = patchId;
            Name = name;
            Version = version;
        ...
        public SoftwareUpdateRebootBehavior RebootBehavior { get; private set; }
        ...
        public PatchAssessmentState AssessmentState { get; private set; }
