...
namespace Microsoft.Azure.Management.Compute.Fluent
{
        ...
        VirtualMachineScaleSet.Update.IWithSystemAssignedIdentityBasedAccessOrApply
    {
        ...
        {
            return new VirtualMachineScaleSetExtensionImpl(new Models.VirtualMachineScaleSetExtensionInner { Name = name }, this);
        }
        ...
        protected override void BeforeCreating()
        {
            if (this.extensions.Count > 0)
            {
                Inner.VirtualMachineProfile
                    ...
                    {
                        Extensions = new List<Models.VirtualMachineScaleSetExtensionInner>()
                    };
