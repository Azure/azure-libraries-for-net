...
namespace Microsoft.Azure.Management.Compute.Fluent
{
        ...
        Microsoft.Azure.Management.ResourceManager.Fluent.Core.IBeta
    {
        ...
        IRunCommandResult RunCommandInVMInstance(string vmId, RunCommandInputInner inputCommand);
        ...
        Task<IRunCommandResult> RunCommandVMInstanceAsync(string vmId, RunCommandInputInner inputCommand, CancellationToken cancellationToken = default(CancellationToken));
        ...
        IRunCommandResult RunPowerShellScriptInVMInstance(string vmId, IList<string> scriptLines, IList<Models.RunCommandInputParameter> scriptParameters);
        ...
        /// <param name="scriptParameters">Script parameters.</param>
        /// <return>Handle to the asynchronous execution.</return>
        Task<IRunCommandResult> RunPowerShellScriptInVMInstanceAsync(string vmId, IList<string> scriptLines, IList<Models.RunCommandInputParameter> scriptParameters, CancellationToken cancellationToken = default(CancellationToken));
        ...
        IRunCommandResult RunShellScriptInVMInstance(string vmId, IList<string> scriptLines, IList<Models.RunCommandInputParameter> scriptParameters);
        ...
        /// <param name="scriptParameters">Script parameters.</param>
        /// <return>Handle to the asynchronous execution.</return>
        Task<IRunCommandResult> RunShellScriptInVMInstanceAsync(string vmId, IList<string> scriptLines, IList<Models.RunCommandInputParameter> scriptParameters, CancellationToken cancellationToken = default(CancellationToken));
    }
}