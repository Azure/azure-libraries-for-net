...
namespace Microsoft.Azure.Management.Compute.Fluent
{
    ...
    internal partial class VirtualMachineOffersImpl
    {
        ...
        {
            return this.List() as System.Collections.Generic.IEnumerable<Microsoft.Azure.Management.Compute.Fluent.IVirtualMachineOffer>;
        }
        ...
        {
            return await this.ListAsync(loadAllPages, cancellationToken) as Microsoft.Azure.Management.ResourceManager.Fluent.Core.IPagedCollection<IVirtualMachineOffer>;
        }
    }
}