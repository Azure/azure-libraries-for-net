...
namespace Microsoft.Azure.Management.Compute.Fluent
{
        ...
        Microsoft.Azure.Management.ResourceManager.Fluent.Core.IBeta
    {
        ...
        Models.RunCommandResultInner RunCommandInVMInstance(string groupName, string scaleSetName, string vmId, RunCommandInputInner inputCommand);
        ...
        Task<Models.RunCommandResultInner> RunCommandVMInstanceAsync(string groupName, string scaleSetName, string vmId, RunCommandInputInner inputCommand, CancellationToken cancellationToken = default(CancellationToken));
