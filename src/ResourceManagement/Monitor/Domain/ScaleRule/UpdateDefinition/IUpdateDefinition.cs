...
namespace Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.UpdateDefinition
{
    ...
    public interface IBlank 
    {
        ...
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.UpdateDefinition.IWithMetricName WithMetricSource(string metricSourceResourceId);
    }
    ...
    public interface IUpdateDefinition  :
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.UpdateDefinition.IBlank,
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.UpdateDefinition.IWithMetricName,
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.UpdateDefinition.IWithStatistic,
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.UpdateDefinition.IWithCondition,
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.UpdateDefinition.IWithScaleAction,
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.UpdateDefinition.IWithAttach
    {
    ...
    public interface IWithAttach  :
        Microsoft.Azure.Management.ResourceManager.Fluent.Core.ChildResource.Update.IInUpdate<Microsoft.Azure.Management.Monitor.Fluent.AutoscaleProfile.Update.IUpdate>
    {
    ...
    public interface IWithMetricName 
    {
        ...
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.UpdateDefinition.IWithStatistic WithMetricName(string metricName);
    }
    ...
    public interface IWithStatistic 
    {
        ...
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.UpdateDefinition.IWithCondition WithStatistic(TimeSpan duration, TimeSpan frequency, MetricStatisticType statisticType);
        ...
        /// </summary>
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.UpdateDefinition.IWithCondition WithStatistic();
        ...
        /// <param name="duration">The range of time in which instance data is collected. This value must be greater than the delay in metric collection, which can vary from resource-to-resource. Must be between 12 hours and 5 minutes.</param>
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.UpdateDefinition.IWithCondition WithStatistic(TimeSpan duration);
        ...
        /// <param name="statisticType">The metric statistic type. How the metrics from multiple instances are combined. Possible values include: 'Average', 'Min', 'Max', 'Sum'.</param>
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.UpdateDefinition.IWithCondition WithStatistic(TimeSpan duration, MetricStatisticType statisticType);
    }
    ...
    public interface IWithScaleAction 
    {
        ...
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.UpdateDefinition.IWithAttach WithScaleAction(ScaleDirection direction, ScaleType type, int instanceCountChange, TimeSpan cooldown);
    }
    ...
    public interface IWithCondition 
    {
        ...
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.UpdateDefinition.IWithScaleAction WithCondition(TimeAggregationType timeAggregation, ComparisonOperationType condition, double threshold);
    }
}