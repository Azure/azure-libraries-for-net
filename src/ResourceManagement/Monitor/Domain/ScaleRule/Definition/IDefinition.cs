...
namespace Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.Definition
{
    ...
    public interface IWithCondition 
    {
        ...
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.Definition.IWithScaleAction WithCondition(ComparisonOperationType condition, TimeAggregationType timeAggregation, double threshold);
    }
