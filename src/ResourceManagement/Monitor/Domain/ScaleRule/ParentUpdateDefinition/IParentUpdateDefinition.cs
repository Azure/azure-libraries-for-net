...
namespace Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.ParentUpdateDefinition
{
    ...
    public interface IWithCondition 
    {
        ...
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.ParentUpdateDefinition.IWithScaleAction WithCondition(TimeAggregationType timeAggregation, ComparisonOperationType condition, double threshold);
    }
    ...
    public interface IWithAttach 
    {
        ...
        Microsoft.Azure.Management.Monitor.Fluent.AutoscaleProfile.UpdateDefinition.IWithScaleRuleOptional Attach();
    }
    ...
    public interface IWithScaleAction 
    {
        ...
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.ParentUpdateDefinition.IWithAttach WithScaleAction(ScaleDirection direction, ScaleType type, int instanceCountChange, TimeSpan cooldown);
    }
    ...
    /// </summary>
    public interface IParentUpdateDefinition  :
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.ParentUpdateDefinition.IBlank,
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.ParentUpdateDefinition.IWithMetricName,
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.ParentUpdateDefinition.IWithStatistic,
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.ParentUpdateDefinition.IWithCondition,
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.ParentUpdateDefinition.IWithScaleAction,
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.ParentUpdateDefinition.IWithAttach
    {
    ...
    public interface IBlank 
    {
        ...
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.ParentUpdateDefinition.IWithMetricName WithMetricSource(string metricSourceResourceId);
    }
    ...
    public interface IWithStatistic 
    {
        ...
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.ParentUpdateDefinition.IWithCondition WithStatistic(TimeSpan duration, TimeSpan frequency, MetricStatisticType statisticType);
        ...
        /// </summary>
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.ParentUpdateDefinition.IWithCondition WithStatistic();
        ...
        /// <param name="duration">The range of time in which instance data is collected. This value must be greater than the delay in metric collection, which can vary from resource-to-resource. Must be between 12 hours and 5 minutes.</param>
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.ParentUpdateDefinition.IWithCondition WithStatistic(TimeSpan duration);
        ...
        /// <param name="statisticType">The metric statistic type. How the metrics from multiple instances are combined. Possible values include: 'Average', 'Min', 'Max', 'Sum'.</param>
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.ParentUpdateDefinition.IWithCondition WithStatistic(TimeSpan duration, MetricStatisticType statisticType);
    }
    ...
    public interface IWithMetricName 
    {
        ...
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.ParentUpdateDefinition.IWithStatistic WithMetricName(string metricName);
    }
}