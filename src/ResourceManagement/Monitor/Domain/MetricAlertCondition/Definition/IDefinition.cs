...
namespace Microsoft.Azure.Management.Monitor.Fluent.MetricAlertCondition.Definition
{
    ...
    public interface IWithCriteriaOperator<ParentT>
    {
        ...
        Microsoft.Azure.Management.Monitor.Fluent.MetricAlertCondition.Definition.IWithConditionAttach<ParentT> WithCondition(MetricAlertRuleTimeAggregation timeAggregation, MetricAlertRuleCondition condition, double threshold);
    }
    ...
    public interface IWithConditionAttach<ParentT>
    {
        ...
        /// <return>The next stage of metric alert condition definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.MetricAlertCondition.Definition.IWithConditionAttach<ParentT> WithDimension(string dimensionName, params string[] values);
    }
}