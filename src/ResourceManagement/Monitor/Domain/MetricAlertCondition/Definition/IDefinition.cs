...
namespace Microsoft.Azure.Management.Monitor.Fluent.MetricAlertCondition.Definition
{
    ...
    public interface IWithCriteriaOperator<ParentT>
    {
        ...
        Microsoft.Azure.Management.Monitor.Fluent.MetricAlertCondition.Definition.IWithConditionAttach<ParentT> WithCondition(MetricAlertRuleCondition condition, MetricAlertRuleTimeAggregation timeAggregation, double threshold);
    }
    ...
    public interface IWithConditionAttach<ParentT>
    {
        ...
        /// <return>The next stage of metric alert condition definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.MetricAlertCondition.Definition.IWithConditionAttach<ParentT> WithDimensionFilter(string dimensionName, params string[] values);
        ...
        /// <return>The next stage of metric alert condition definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.MetricAlertCondition.Definition.IWithConditionAttach<ParentT> WithMetricNamespace(string metricNamespace);
    }
}