...
namespace Microsoft.Azure.Management.Monitor.Fluent.AutoscaleProfile.Definition
{
    using System;
    ...
    public interface IWithScaleRule 
    {
        ...
        Microsoft.Azure.Management.Monitor.Fluent.ScaleRule.Definition.IBlank DefineScaleRule();
    }
    ...
    public interface IWithScaleSchedule 
    {
        ...
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.AutoscaleProfile.Definition.IWithAttach WithFixedDateSchedule(string timeZone, DateTime start, DateTime end);
        ...
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.AutoscaleProfile.Definition.IWithAttach WithRecurrentSchedule(string scheduleTimeZone, string startTime, params Models.DayOfWeek[] weekday);
    }
    ...
    public interface IWithAttach  :
        Microsoft.Azure.Management.ResourceManager.Fluent.Core.ChildResource.Definition.IInDefinition<Microsoft.Azure.Management.Monitor.Fluent.AutoscaleSetting.Definition.IWithCreate>
    {
    ...
    public interface IWithScaleRuleOptional  :
        Microsoft.Azure.Management.Monitor.Fluent.AutoscaleProfile.Definition.IWithAttach
    {
        ...
        /// <param name="end">End time.</param>
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.AutoscaleProfile.Definition.IWithScaleRuleOptional WithFixedDateSchedule(string timeZone, DateTime start, DateTime end);
        ...
        /// <param name="weekday">List of week days when the schedule should be active.</param>
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.AutoscaleProfile.Definition.IWithScaleRuleOptional WithRecurrentSchedule(string scheduleTimeZone, string startTime, params Models.DayOfWeek[] weekday);
    }
    ...
    public interface IDefinition  :
        Microsoft.Azure.Management.Monitor.Fluent.AutoscaleProfile.Definition.IWithAttach,
        Microsoft.Azure.Management.Monitor.Fluent.AutoscaleProfile.Definition.IBlank,
        Microsoft.Azure.Management.Monitor.Fluent.AutoscaleProfile.Definition.IWithScaleRule,
        Microsoft.Azure.Management.Monitor.Fluent.AutoscaleProfile.Definition.IWithScaleRuleOptional,
        Microsoft.Azure.Management.Monitor.Fluent.AutoscaleProfile.Definition.IWithScaleSchedule
    {
    ...
    public interface IBlank 
    {
        ...
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.AutoscaleProfile.Definition.IWithAttach WithFixedInstanceCount(int instanceCount);
        ...
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.AutoscaleProfile.Definition.IWithScaleRule WithMetricBasedScale(int minimumInstanceCount, int maximumInstanceCount, int defaultInstanceCount);
        ...
        /// <param name="instanceCount">The number of instances that will be set during specified schedule. The actual number of instances is limited by the cores that are available in the subscription.</param>
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Monitor.Fluent.AutoscaleProfile.Definition.IWithScaleSchedule WithScheduleBasedScale(int instanceCount);
    }
}