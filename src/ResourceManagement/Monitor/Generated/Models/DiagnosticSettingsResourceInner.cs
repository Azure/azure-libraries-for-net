...
namespace Microsoft.Azure.Management.Monitor.Fluent.Models
{
    ...
    public partial class DiagnosticSettingsResourceInner : ProxyOnlyResource
    {
        ...
        public DiagnosticSettingsResourceInner(string id = default(string), string name = default(string), string type = default(string), string storageAccountId = default(string), string eventHubAuthorizationRuleId = default(string), string eventHubName = default(string), IList<MetricSettings> metrics = default(IList<MetricSettings>), IList<LogSettings> logs = default(IList<LogSettings>), string workspaceId = default(string))
            : base(id, name, type)
        {
