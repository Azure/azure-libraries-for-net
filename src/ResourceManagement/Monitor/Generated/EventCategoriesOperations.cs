...
namespace Microsoft.Azure.Management.Monitor.Fluent
{
    ...
    internal partial class EventCategoriesOperations : IServiceOperations<MonitorManagementClient>, IEventCategoriesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<LocalizableStringInner>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<LocalizableStringInner>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page1<LocalizableStringInner>>(_responseContent, Client.DeserializationSettings);
                }
