...
namespace Microsoft.Azure.Management.Monitor.Fluent
{
    ...
    internal partial class LogProfilesOperations : IServiceOperations<MonitorManagementClient>, ILogProfilesOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<LogProfileResourceInner>> UpdateWithHttpMessagesAsync(string logProfileName, LogProfileResourcePatch logProfilesResource, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
