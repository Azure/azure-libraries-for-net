...
namespace Microsoft.Azure.Management.Monitor.Fluent
{
    ...
    internal partial class MetricBaselineOperations : IServiceOperations<MonitorManagementClient>, IMetricBaselineOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<CalculateBaselineResponseInner>> CalculateBaselineWithHttpMessagesAsync(string resourceUri, TimeSeriesInformation timeSeriesInformation, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceUri == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceUri");
