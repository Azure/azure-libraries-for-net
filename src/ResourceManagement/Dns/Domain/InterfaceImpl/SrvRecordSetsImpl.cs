...
namespace Microsoft.Azure.Management.Dns.Fluent
{
    ...
    internal partial class SrvRecordSetsImpl
    {
        ...
        Task<Microsoft.Azure.Management.Dns.Fluent.ISrvRecordSet> Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsGettingByName<Microsoft.Azure.Management.Dns.Fluent.ISrvRecordSet>.GetByNameAsync(string name, CancellationToken cancellationToken)
        {
            return this.GetByNameAsync(name, cancellationToken) as Task<Microsoft.Azure.Management.Dns.Fluent.ISrvRecordSet>;
        }
    }
}