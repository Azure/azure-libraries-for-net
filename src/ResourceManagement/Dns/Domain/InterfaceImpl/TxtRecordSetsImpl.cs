...
namespace Microsoft.Azure.Management.Dns.Fluent
{
    ...
    internal partial class TxtRecordSetsImpl
    {
        ...
        Task<Microsoft.Azure.Management.Dns.Fluent.ITxtRecordSet> Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsGettingByName<Microsoft.Azure.Management.Dns.Fluent.ITxtRecordSet>.GetByNameAsync(string name, CancellationToken cancellationToken)
        {
            return this.GetByNameAsync(name, cancellationToken) as Task<Microsoft.Azure.Management.Dns.Fluent.ITxtRecordSet>;
        }
    }
}