...
namespace Microsoft.Azure.Management.Dns.Fluent
{
    ...
    internal partial class AaaaRecordSetsImpl
    {
        ...
        Task<Microsoft.Azure.Management.Dns.Fluent.IAaaaRecordSet> Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsGettingByName<Microsoft.Azure.Management.Dns.Fluent.IAaaaRecordSet>.GetByNameAsync(string name, CancellationToken cancellationToken)
        {
            return this.GetByNameAsync(name, cancellationToken) as Task<Microsoft.Azure.Management.Dns.Fluent.IAaaaRecordSet>;
        }
    }
}