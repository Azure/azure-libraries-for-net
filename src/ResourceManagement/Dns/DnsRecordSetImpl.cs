...
namespace Microsoft.Azure.Management.Dns.Fluent
{
        ...
        IUpdateCombined
    {
        ...
        protected override async Task<RecordSetInner> GetInnerAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        ///GENMHASH:0202A00A1DCF248D2647DBDBEF2CA865:18B12FED433DF6A1F3CA0DD1940B789C
        ...
        ///GENMHASH:3802EA6243E9AF80A622FF944E74B5EA:03D0507196E92D3034FCCE67ABC7ADA9
        public RecordType RecordType()
        {
            var fullyQualifiedType = this.type;
        ...
        ///GENMHASH:507A92D4DCD93CE9595A78198DEBDFCF:A945C11E2DCC935424E5B666E47F3D2C
        ...
        ///GENMHASH:2965B3FB0030FC60CED746B78EE838F3:DFE43DACAEDDF987BEDF786B4989C489
        public DnsRecordSetImpl WithoutRecord(int flags, string tag, string value)
        {
            this.recordSetRemoveInfo.CaaRecords
                .Add(new CaaRecord
                {
                    Flags = flags,
                    Tag = tag,
        ...
        ///GENMHASH:6AA2FF71573E83BF2E72B639167FEB03:2CE5820762CA700DB500887C608143C5
        ...
        ///GENMHASH:6300EBC9252C6530D70C1A6340171C08:0B11517DD7B5F9988EBD2D8574642F18
