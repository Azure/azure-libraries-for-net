    ...
    internal partial class ExpressRouteCircuitPeeringsOperations : IServiceOperations<NetworkManagementClient>, IExpressRouteCircuitPeeringsOperations
    {
        ...
        public async Task<AzureOperationResponse<ExpressRouteCircuitPeeringInner>> GetWithHttpMessagesAsync(string resourceGroupName, string circuitName, string peeringName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ExpressRouteCircuitPeeringInner>(_responseContent, Client.DeserializationSettings);
                }
        ...
        {
            // Send Request
            AzureOperationResponse<ExpressRouteCircuitPeeringInner> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, circuitName, peeringName, peeringParameters, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        public async Task<AzureOperationResponse<IPage<ExpressRouteCircuitPeeringInner>>> ListWithHttpMessagesAsync(string resourceGroupName, string circuitName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<ExpressRouteCircuitPeeringInner>>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
