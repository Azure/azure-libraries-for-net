...
namespace Microsoft.Azure.Management.Network.Fluent
{
    ...
    public partial interface INetworkSecurityGroupsOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<NetworkSecurityGroupInner>> BeginUpdateTagsWithHttpMessagesAsync(string resourceGroupName, string networkSecurityGroupName, IDictionary<string, string> tags = default(IDictionary<string, string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets all network security groups in a subscription.
        /// </summary>
