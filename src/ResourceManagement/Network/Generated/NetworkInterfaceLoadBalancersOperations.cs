...
namespace Microsoft.Azure.Management.Network.Fluent
{
    ...
    internal partial class NetworkInterfaceLoadBalancersOperations : IServiceOperations<NetworkManagementClient>, INetworkInterfaceLoadBalancersOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<LoadBalancerInner>>> ListWithHttpMessagesAsync(string resourceGroupName, string networkInterfaceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
