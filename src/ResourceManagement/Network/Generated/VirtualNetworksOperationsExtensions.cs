...
namespace Microsoft.Azure.Management.Network.Fluent
{
    ...
    public static partial class VirtualNetworksOperationsExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<VirtualNetworkInner> UpdateTagsAsync(this IVirtualNetworksOperations operations, string resourceGroupName, string virtualNetworkName, IDictionary<string, string> tags = default(IDictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.UpdateTagsWithHttpMessagesAsync(resourceGroupName, virtualNetworkName, tags, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<VirtualNetworkInner> BeginUpdateTagsAsync(this IVirtualNetworksOperations operations, string resourceGroupName, string virtualNetworkName, IDictionary<string, string> tags = default(IDictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginUpdateTagsWithHttpMessagesAsync(resourceGroupName, virtualNetworkName, tags, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
