...
namespace Microsoft.Azure.Management.Network.Fluent
{
    ...
    internal partial class ServiceTagsOperations : IServiceOperations<NetworkManagementClient>, IServiceTagsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ServiceTagsListResultInner>> ListWithHttpMessagesAsync(string location, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (location == null)
            {
            ...
            // Create Result
            var _result = new AzureOperationResponse<ServiceTagsListResultInner>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ServiceTagsListResultInner>(_responseContent, Client.DeserializationSettings);
                }
