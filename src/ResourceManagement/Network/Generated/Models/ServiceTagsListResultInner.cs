...
namespace Microsoft.Azure.Management.Network.Fluent.Models
{
    ...
    /// </summary>
    public partial class ServiceTagsListResultInner
    {
        /// <summary>
        ...
        /// resources.</param>
        public ServiceTagsListResultInner(string name = default(string), string id = default(string), string type = default(string), string changeNumber = default(string), string cloud = default(string), IList<ServiceTagInformation> values = default(IList<ServiceTagInformation>))
        {
            Name = name;
            Id = id;
            Type = type;
