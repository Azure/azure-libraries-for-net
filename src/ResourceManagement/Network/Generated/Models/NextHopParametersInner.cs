...
namespace Microsoft.Azure.Management.Network.Fluent.Models
{
    ...
    /// </summary>
    public partial class NextHopParametersInner
    {
        /// <summary>
        /// Initializes a new instance of the NextHopParametersInner class.
        /// </summary>
        public NextHopParametersInner()
        {
            CustomInit();
        }
        ...
        public NextHopParametersInner(string targetResourceId, string sourceIPAddress, string destinationIPAddress, string targetNicResourceId = default(string))
        {
