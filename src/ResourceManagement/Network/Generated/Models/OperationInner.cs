...
namespace Microsoft.Azure.Management.Network.Fluent.Models
{
    ...
    public partial class OperationInner
    {
        ...
        /// service.</param>
        public OperationInner(string name = default(string), OperationDisplay display = default(OperationDisplay), string origin = default(string), OperationPropertiesFormatServiceSpecification serviceSpecification = default(OperationPropertiesFormatServiceSpecification))
        {
            Name = name;
            Display = display;
            Origin = origin;
