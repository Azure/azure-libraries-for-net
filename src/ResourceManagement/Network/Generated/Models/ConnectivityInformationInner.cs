...
namespace Microsoft.Azure.Management.Network.Fluent.Models
{
    ...
    public partial class ConnectivityInformationInner
    {
        ...
        public ConnectivityInformationInner(IList<ConnectivityHop> hops = default(IList<ConnectivityHop>), string connectionStatus = default(string), int? avgLatencyInMs = default(int?), int? minLatencyInMs = default(int?), int? maxLatencyInMs = default(int?), int? probesSent = default(int?), int? probesFailed = default(int?))
        {
            Hops = hops;
