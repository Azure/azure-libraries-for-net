...
namespace Microsoft.Azure.Management.Network.Fluent.Models
{
    ...
    public partial class PacketCaptureQueryStatusResultInner
    {
        ...
        /// session.</param>
        public PacketCaptureQueryStatusResultInner(string name = default(string), string id = default(string), System.DateTime? captureStartTime = default(System.DateTime?), string packetCaptureStatus = default(string), string stopReason = default(string), IList<string> packetCaptureError = default(IList<string>))
        {
            Name = name;
            Id = id;
