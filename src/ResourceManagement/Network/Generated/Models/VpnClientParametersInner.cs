...
namespace Microsoft.Azure.Management.Network.Fluent.Models
{
    ...
    /// </summary>
    public partial class VpnClientParametersInner
    {
        /// <summary>
        /// Initializes a new instance of the VpnClientParametersInner class.
        /// </summary>
        public VpnClientParametersInner()
        {
            CustomInit();
        }
        ...
        /// EAPTLS.</param>
        public VpnClientParametersInner(string processorArchitecture = default(string), string authenticationMethod = default(string), string radiusServerAuthCertificate = default(string), IList<string> clientRootCertificates = default(IList<string>))
        {
