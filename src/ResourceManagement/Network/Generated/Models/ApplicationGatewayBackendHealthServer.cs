...
namespace Microsoft.Azure.Management.Network.Fluent.Models
{
    ...
    public partial class ApplicationGatewayBackendHealthServer
    {
        ...
        public ApplicationGatewayBackendHealthServer(string address = default(string), NetworkInterfaceIPConfigurationInner ipConfiguration = default(NetworkInterfaceIPConfigurationInner), string health = default(string))
        {
            Address = address;
