...
namespace Microsoft.Azure.Management.Network.Fluent.Models
{
    ...
    public partial class AzureFirewallApplicationRuleCollectionInner : Management.ResourceManager.Fluent.SubResource
    {
        /// <summary>
        /// Initializes a new instance of the
        /// AzureFirewallApplicationRuleCollectionInner class.
        /// </summary>
        ...
        public AzureFirewallApplicationRuleCollectionInner(string id = default(string), int? priority = default(int?), AzureFirewallRCAction action = default(AzureFirewallRCAction), IList<AzureFirewallApplicationRule> rules = default(IList<AzureFirewallApplicationRule>), ProvisioningState provisioningState = default(ProvisioningState), string name = default(string), string etag = default(string))
            : base(id)
        {
            Priority = priority;
            Action = action;
