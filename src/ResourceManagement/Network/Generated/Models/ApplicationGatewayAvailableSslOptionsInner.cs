...
namespace Microsoft.Azure.Management.Network.Fluent.Models
{
    ...
    public partial class ApplicationGatewayAvailableSslOptionsInner : Microsoft.Azure.Management.ResourceManager.Fluent.Resource
    {
        /// <summary>
        ...
        /// protocols.</param>
        public ApplicationGatewayAvailableSslOptionsInner(string location = default(string), string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), IList<Microsoft.Azure.Management.ResourceManager.Fluent.SubResource> predefinedPolicies = default(IList<Microsoft.Azure.Management.ResourceManager.Fluent.SubResource>), string defaultPolicy = default(string), IList<string> availableCipherSuites = default(IList<string>), IList<string> availableProtocols = default(IList<string>))
        ...
        public IList<Microsoft.Azure.Management.ResourceManager.Fluent.SubResource> PredefinedPolicies { get; set; }
