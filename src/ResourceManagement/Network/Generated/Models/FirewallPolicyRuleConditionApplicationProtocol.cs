...
namespace Microsoft.Azure.Management.Network.Fluent.Models
{
    ...
    public partial class FirewallPolicyRuleConditionApplicationProtocol
    {
        ...
        /// than 64000.</param>
        public FirewallPolicyRuleConditionApplicationProtocol(FirewallPolicyRuleConditionApplicationProtocolType protocolType = default(FirewallPolicyRuleConditionApplicationProtocolType), int? port = default(int?))
        {
