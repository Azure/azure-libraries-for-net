...
namespace Microsoft.Azure.Management.Network.Fluent.Models
{
    ...
    public partial class RouteFilterRuleInner : Management.ResourceManager.Fluent.SubResource
    {
        /// <summary>
        ...
        public RouteFilterRuleInner(Access access, IList<string> communities, string id = default(string), ProvisioningState provisioningState = default(ProvisioningState), string name = default(string), string location = default(string), string etag = default(string))
            : base(id)
        {
            Access = access;
