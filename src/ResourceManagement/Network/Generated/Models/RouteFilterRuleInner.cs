...
namespace Microsoft.Azure.Management.Network.Fluent.Models
{
    ...
    public partial class RouteFilterRuleInner : Management.ResourceManager.Fluent.SubResource
    {
        ...
        public RouteFilterRuleInner(Access access, IList<string> communities, string id = default(string), string provisioningState = default(string), string name = default(string), string location = default(string), string etag = default(string))
            : base(id)
        {
            Access = access;
