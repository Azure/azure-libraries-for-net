...
namespace Microsoft.Azure.Management.Network.Fluent
{
    ...
    internal partial class LoadBalancerNetworkInterfacesOperations : IServiceOperations<NetworkManagementClient>, ILoadBalancerNetworkInterfacesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<NetworkInterfaceInner>>> ListWithHttpMessagesAsync(string resourceGroupName, string loadBalancerName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
