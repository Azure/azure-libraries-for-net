...
namespace Microsoft.Azure.Management.Network.Fluent
{
    ...
    public static partial class ServiceTagsOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<ServiceTagsListResultInner> ListAsync(this IServiceTagsOperations operations, string location, CancellationToken cancellationToken = default(CancellationToken))
            {
