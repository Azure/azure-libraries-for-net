...
namespace Microsoft.Azure.Management.Network.Fluent
{
    ...
    public partial interface IAvailableResourceGroupDelegationsOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<IPage<AvailableDelegationInner>>> ListWithHttpMessagesAsync(string location, string resourceGroupName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets all of the available subnet delegations for this resource
        /// group in this region.
        /// </summary>
