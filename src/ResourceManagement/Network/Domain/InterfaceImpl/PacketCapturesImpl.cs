...
namespace Microsoft.Azure.Management.Network.Fluent
{
    ...
    internal partial class PacketCapturesImpl
    {
        ...
        /// <param name="name">The name of the resource. (Note, this is not the resource ID.).</param>
        /// <return>An immutable representation of the resource.</return>
        async Task<Microsoft.Azure.Management.Network.Fluent.IPacketCapture> Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsGettingByName<Microsoft.Azure.Management.Network.Fluent.IPacketCapture>.GetByNameAsync(string name, CancellationToken cancellationToken)
        {
