...
namespace Microsoft.Azure.Management.Network.Fluent.Models
{
    ...
    {
        public static readonly PublicIPSkuType Basic = Parse(PublicIPAddressSkuName.Basic);
        public static readonly PublicIPSkuType Standard = Parse(PublicIPAddressSkuName.Standard);
    }
}