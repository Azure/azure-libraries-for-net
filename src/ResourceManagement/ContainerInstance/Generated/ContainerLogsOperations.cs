...
namespace Microsoft.Azure.Management.ContainerInstance.Fluent
{
    ...
    internal partial class ContainerLogsOperations : IServiceOperations<ContainerInstanceManagementClient>, IContainerLogsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<LogsInner>> ListWithHttpMessagesAsync(string resourceGroupName, string containerName, string containerGroupName, int? tail = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
