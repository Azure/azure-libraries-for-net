...
namespace Microsoft.Azure.Management.ContainerInstance.Fluent
{
    ...
    public static partial class ContainerGroupUsageOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<UsageListResultInner> ListAsync(this IContainerGroupUsageOperations operations, string location, CancellationToken cancellationToken = default(CancellationToken))
            {
