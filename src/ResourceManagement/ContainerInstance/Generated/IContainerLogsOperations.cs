...
namespace Microsoft.Azure.Management.ContainerInstance.Fluent
{
    ...
    public partial interface IContainerLogsOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<LogsInner>> ListWithHttpMessagesAsync(string resourceGroupName, string containerName, string containerGroupName, int? tail = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
