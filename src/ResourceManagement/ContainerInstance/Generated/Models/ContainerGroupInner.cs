...
namespace Microsoft.Azure.Management.ContainerInstance.Fluent.Models
{
    ...
    public partial class ContainerGroupInner : Microsoft.Azure.Management.ResourceManager.Fluent.Resource
    {
        ...
        public ContainerGroupInner(string location = default(string), string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string provisioningState = default(string), IList<Container> containers = default(IList<Container>), IList<ImageRegistryCredential> imageRegistryCredentials = default(IList<ImageRegistryCredential>), string restartPolicy = default(string), IpAddress ipAddress = default(IpAddress), string osType = default(string), string state = default(string), IList<Volume> volumes = default(IList<Volume>))
