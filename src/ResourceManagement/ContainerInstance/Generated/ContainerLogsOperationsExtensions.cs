...
namespace Microsoft.Azure.Management.ContainerInstance.Fluent
{
    ...
    public static partial class ContainerLogsOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<LogsInner> ListAsync(this IContainerLogsOperations operations, string resourceGroupName, string containerGroupName, string containerName, int? tail = default(int?), CancellationToken cancellationToken = default(CancellationToken))
            {
