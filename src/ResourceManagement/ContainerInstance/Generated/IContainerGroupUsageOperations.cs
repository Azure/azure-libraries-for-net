...
namespace Microsoft.Azure.Management.ContainerInstance.Fluent
{
    ...
    public partial interface IContainerGroupUsageOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<UsageListResultInner>> ListWithHttpMessagesAsync(string location, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
