...
namespace Microsoft.Azure.Management.ContainerInstance.Fluent
{
    ...
    internal partial class StartContainerOperations : IServiceOperations<ContainerInstanceManagementClient>, IStartContainerOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ContainerExecResponseInner>> LaunchExecWithHttpMessagesAsync(string resourceGroupName, string containerGroupName, string containerName, ContainerExecRequestInner containerExecRequest, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
