...
namespace Microsoft.Azure.Management.ContainerInstance.Fluent
{
    ...
    public partial class ContainerInstanceManagementClient : ServiceClient<ContainerInstanceManagementClient>, IContainerInstanceManagementClient, IAzureClient
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<CachedImagesListResultInner>> ListCachedImagesWithHttpMessagesAsync(string location, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<CachedImagesListResultInner>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<CachedImagesListResultInner>(_responseContent, DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<CapabilitiesListResultInner>> ListCapabilitiesWithHttpMessagesAsync(string location, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.SubscriptionId");
            ...
            // Create Result
            var _result = new AzureOperationResponse<CapabilitiesListResultInner>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<CapabilitiesListResultInner>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
