...
namespace Microsoft.Azure.Management.ContainerInstance.Fluent
{
    ...
    internal partial class ContainerGroupUsageOperations : IServiceOperations<ContainerInstanceManagementClient>, IContainerGroupUsageOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<UsageListResultInner>> ListWithHttpMessagesAsync(string location, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<UsageListResultInner>(_responseContent, Client.DeserializationSettings);
                }
