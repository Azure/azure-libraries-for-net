...
namespace Microsoft.Azure.Management.ContainerInstance.Fluent
{
    ...
    public partial interface IStartContainerOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<ContainerExecResponseInner>> LaunchExecWithHttpMessagesAsync(string resourceGroupName, string containerGroupName, string containerName, ContainerExecRequestInner containerExecRequest, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
