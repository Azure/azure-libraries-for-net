...
namespace Microsoft.Azure.Management.Graph.RBAC.Fluent
{
    ...
    internal partial class GroupsOperations : IServiceOperations<GraphRbacManagementClient>, IGroupsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<CheckGroupMembershipResultInner>> IsMemberOfWithHttpMessagesAsync(CheckGroupMembershipParameters parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (parameters == null)
            {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<ADGroupInner>> CreateWithHttpMessagesAsync(GroupCreateParameters parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (parameters == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "parameters");
