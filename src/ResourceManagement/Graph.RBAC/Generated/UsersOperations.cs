...
namespace Microsoft.Azure.Management.Graph.RBAC.Fluent
{
    ...
    internal partial class UsersOperations : IServiceOperations<GraphRbacManagementClient>, IUsersOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<UserInner>> CreateWithHttpMessagesAsync(UserCreateParameters parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (parameters == null)
            {
