...
namespace Microsoft.Azure.Management.Graph.RBAC.Fluent
{
    ...
    internal partial class DeletedApplicationsOperations : IServiceOperations<GraphRbacManagementClient>, IDeletedApplicationsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ApplicationInner>> RestoreWithHttpMessagesAsync(string objectId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (objectId == null)
            {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<ApplicationInner>>> ListWithHttpMessagesAsync(string filter = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.ApiVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.ApiVersion");
