...
namespace Microsoft.Azure.Management.Graph.RBAC.Fluent.Models
{
    ...
    public partial class AADObjectInner
    {
        ...
        public AADObjectInner(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string objectId = default(string), string objectType = default(string), string displayName = default(string), string userPrincipalName = default(string), string mail = default(string), bool? mailEnabled = default(bool?), string mailNickname = default(string), bool? securityEnabled = default(bool?), string signInName = default(string), IList<string> servicePrincipalNames = default(IList<string>), string userType = default(string), string usageLocation = default(string), string appId = default(string), IList<string> appPermissions = default(IList<string>), bool? availableToOtherTenants = default(bool?), IList<string> identifierUris = default(IList<string>), IList<string> replyUrls = default(IList<string>), string homepage = default(string))
        {
