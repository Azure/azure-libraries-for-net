...
namespace Microsoft.Azure.Management.Graph.RBAC.Fluent.Models
{
    ...
    public partial class ClassicAdministratorInner
    {
        /// <summary>
        /// Initializes a new instance of the ClassicAdministratorInner class.
        /// </summary>
        ...
        public ClassicAdministratorInner(string id = default(string), string name = default(string), string type = default(string), string emailAddress = default(string), string role = default(string))
        {
            Id = id;
            Name = name;
            Type = type;
