...
namespace Microsoft.Azure.Management.Graph.RBAC.Fluent.Models
{
    ...
    /// </summary>
    public partial class ProviderOperationsMetadataInner
    {
        /// <summary>
        /// Initializes a new instance of the ProviderOperationsMetadataInner
        /// class.
        /// </summary>
        ...
        public ProviderOperationsMetadataInner(string id = default(string), string name = default(string), string type = default(string), string displayName = default(string), IList<ResourceType> resourceTypes = default(IList<ResourceType>), IList<ProviderOperation> operations = default(IList<ProviderOperation>))
        {
            Id = id;
            Name = name;
            Type = type;
