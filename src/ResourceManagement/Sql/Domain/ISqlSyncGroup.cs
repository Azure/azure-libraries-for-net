...
namespace Microsoft.Azure.Management.Sql.Fluent
{
        ...
        Microsoft.Azure.Management.ResourceManager.Fluent.Core.ResourceActions.IUpdatable<SqlSyncGroup.Update.IUpdate>
    {
        ...
        Task<IEnumerable<Microsoft.Azure.Management.Sql.Fluent.ISqlSyncGroupLogProperty>> ListLogsAsync(string startTime, string endTime, string type, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Collections.Generic.IEnumerable<Microsoft.Azure.Management.Sql.Fluent.ISqlSyncGroupLogProperty> ListLogs(string startTime, string endTime, string type);
