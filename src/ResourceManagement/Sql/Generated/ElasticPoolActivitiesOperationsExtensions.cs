...
namespace Microsoft.Azure.Management.Sql.Fluent
{
    ...
    public static partial class ElasticPoolActivitiesOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<IEnumerable<ElasticPoolActivityInner>> ListByElasticPoolAsync(this IElasticPoolActivitiesOperations operations, string resourceGroupName, string serverName, string elasticPoolName, CancellationToken cancellationToken = default(CancellationToken))
            {
