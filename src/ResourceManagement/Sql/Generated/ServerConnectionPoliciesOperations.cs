...
namespace Microsoft.Azure.Management.Sql.Fluent
{
    ...
    internal partial class ServerConnectionPoliciesOperations : IServiceOperations<SqlManagementClient>, IServerConnectionPoliciesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ServerConnectionPolicyInner>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string serverName, ServerConnectionType connectionType, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            parameters.ConnectionType = connectionType;
            // Tracing
            ...
            // Create Result
            var _result = new AzureOperationResponse<ServerConnectionPolicyInner>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ServerConnectionPolicyInner>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<ServerConnectionPolicyInner>> GetWithHttpMessagesAsync(string resourceGroupName, string serverName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
