...
namespace Microsoft.Azure.Management.Sql.Fluent.Models
{
    ...
    public partial class BackupShortTermRetentionPolicyInner : ProxyResourceInner
    {
        /// <summary>
        ...
        /// supported.</param>
        public BackupShortTermRetentionPolicyInner(string id = default(string), string name = default(string), string type = default(string), int? retentionDays = default(int?))
            : base(id, name, type)
        {
