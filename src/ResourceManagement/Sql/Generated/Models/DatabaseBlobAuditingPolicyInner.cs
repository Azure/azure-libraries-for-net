...
namespace Microsoft.Azure.Management.Sql.Fluent.Models
{
    ...
    public partial class DatabaseBlobAuditingPolicyInner : ProxyResourceInner
    {
        /// <summary>
        /// Initializes a new instance of the DatabaseBlobAuditingPolicyInner
        /// class.
        /// </summary>
        ...
        /// </param>
        public DatabaseBlobAuditingPolicyInner(BlobAuditingPolicyState state, string id = default(string), string name = default(string), string type = default(string), string kind = default(string), string storageEndpoint = default(string), string storageAccountAccessKey = default(string), int? retentionDays = default(int?), IList<string> auditActionsAndGroups = default(IList<string>), System.Guid? storageAccountSubscriptionId = default(System.Guid?), bool? isStorageSecondaryKeyInUse = default(bool?), bool? isAzureMonitorTargetEnabled = default(bool?))
            : base(id, name, type)
        {
            Kind = kind;
            State = state;
