...
namespace Microsoft.Azure.Management.Sql.Fluent.Models
{
    ...
    public partial class ServerUpdateInner
    {
        /// <summary>
        /// Initializes a new instance of the ServerUpdateInner class.
        /// </summary>
        public ServerUpdateInner()
        {
            CustomInit();
        }
        ...
        public ServerUpdateInner(string administratorLogin = default(string), string administratorLoginPassword = default(string), string version = default(string), string state = default(string), string fullyQualifiedDomainName = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
        {
