...
namespace Microsoft.Azure.Management.Sql.Fluent
{
    ...
    internal partial class TransparentDataEncryptionsOperations : IServiceOperations<SqlManagementClient>, ITransparentDataEncryptionsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<TransparentDataEncryptionInner>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string serverName, string databaseName, TransparentDataEncryptionState? status = default(TransparentDataEncryptionState?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<TransparentDataEncryptionInner>> GetWithHttpMessagesAsync(string resourceGroupName, string serverName, string databaseName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
