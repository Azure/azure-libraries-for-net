...
namespace Microsoft.Azure.Management.Sql.Fluent
{
    ...
    internal partial class ElasticPoolActivitiesOperations : IServiceOperations<SqlManagementClient>, IElasticPoolActivitiesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<ElasticPoolActivityInner>>> ListByElasticPoolWithHttpMessagesAsync(string resourceGroupName, string serverName, string elasticPoolName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
