...
namespace Microsoft.Azure.Management.Sql.Fluent
{
    ...
    internal partial class DatabaseBlobAuditingPoliciesOperations : IServiceOperations<SqlManagementClient>, IDatabaseBlobAuditingPoliciesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<DatabaseBlobAuditingPolicyInner>> GetWithHttpMessagesAsync(string resourceGroupName, string serverName, string databaseName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<DatabaseBlobAuditingPolicyInner>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<DatabaseBlobAuditingPolicyInner>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<DatabaseBlobAuditingPolicyInner>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string serverName, string databaseName, DatabaseBlobAuditingPolicyInner parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
