...
namespace Microsoft.Azure.Management.Sql.Fluent
{
    ...
    internal partial class ExtendedDatabaseBlobAuditingPoliciesOperations : IServiceOperations<SqlManagementClient>, IExtendedDatabaseBlobAuditingPoliciesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ExtendedDatabaseBlobAuditingPolicyInner>> GetWithHttpMessagesAsync(string resourceGroupName, string serverName, string databaseName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<ExtendedDatabaseBlobAuditingPolicyInner>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ExtendedDatabaseBlobAuditingPolicyInner>(_responseContent, Client.DeserializationSettings);
                }
