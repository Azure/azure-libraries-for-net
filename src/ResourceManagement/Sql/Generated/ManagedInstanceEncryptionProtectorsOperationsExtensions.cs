...
namespace Microsoft.Azure.Management.Sql.Fluent
{
    ...
    public static partial class ManagedInstanceEncryptionProtectorsOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<IPage<ManagedInstanceEncryptionProtectorInner>> ListByInstanceAsync(this IManagedInstanceEncryptionProtectorsOperations operations, string resourceGroupName, string managedInstanceName, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ManagedInstanceEncryptionProtectorInner> CreateOrUpdateAsync(this IManagedInstanceEncryptionProtectorsOperations operations, string resourceGroupName, string managedInstanceName, ManagedInstanceEncryptionProtectorInner parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ManagedInstanceEncryptionProtectorInner> BeginCreateOrUpdateAsync(this IManagedInstanceEncryptionProtectorsOperations operations, string resourceGroupName, string managedInstanceName, ManagedInstanceEncryptionProtectorInner parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
