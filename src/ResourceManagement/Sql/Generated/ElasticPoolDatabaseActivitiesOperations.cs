...
namespace Microsoft.Azure.Management.Sql.Fluent
{
    ...
    internal partial class ElasticPoolDatabaseActivitiesOperations : IServiceOperations<SqlManagementClient>, IElasticPoolDatabaseActivitiesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<ElasticPoolDatabaseActivityInner>>> ListByElasticPoolWithHttpMessagesAsync(string resourceGroupName, string serverName, string elasticPoolName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
