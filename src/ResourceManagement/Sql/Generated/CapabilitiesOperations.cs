...
namespace Microsoft.Azure.Management.Sql.Fluent
{
    ...
    internal partial class CapabilitiesOperations : IServiceOperations<SqlManagementClient>, ICapabilitiesOperations
    {
        ...
        public async Task<AzureOperationResponse<LocationCapabilitiesInner>> ListByLocationWithHttpMessagesAsync(string locationId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<LocationCapabilitiesInner>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<LocationCapabilitiesInner>(_responseContent, Client.DeserializationSettings);
                }
