...
namespace Microsoft.Azure.Management.Sql.Fluent
{
    ...
    internal partial class DatabaseThreatDetectionPoliciesOperations : IServiceOperations<SqlManagementClient>, IDatabaseThreatDetectionPoliciesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<DatabaseSecurityAlertPolicyInner>> GetWithHttpMessagesAsync(string resourceGroupName, string serverName, string databaseName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<DatabaseSecurityAlertPolicyInner>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<DatabaseSecurityAlertPolicyInner>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<DatabaseSecurityAlertPolicyInner>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string serverName, string databaseName, DatabaseSecurityAlertPolicyInner parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
