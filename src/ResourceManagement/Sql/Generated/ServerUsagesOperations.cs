...
namespace Microsoft.Azure.Management.Sql.Fluent
{
    ...
    internal partial class ServerUsagesOperations : IServiceOperations<SqlManagementClient>, IServerUsagesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<ServerUsageInner>>> ListByServerWithHttpMessagesAsync(string resourceGroupName, string serverName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<ServerUsageInner>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<ServerUsageInner>>(_responseContent, Client.DeserializationSettings);
                }
