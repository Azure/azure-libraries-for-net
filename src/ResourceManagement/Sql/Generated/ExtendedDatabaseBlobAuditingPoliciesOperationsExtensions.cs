...
namespace Microsoft.Azure.Management.Sql.Fluent
{
    ...
    public static partial class ExtendedDatabaseBlobAuditingPoliciesOperationsExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ExtendedDatabaseBlobAuditingPolicyInner> CreateOrUpdateAsync(this IExtendedDatabaseBlobAuditingPoliciesOperations operations, string resourceGroupName, string serverName, string databaseName, ExtendedDatabaseBlobAuditingPolicyInner parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
