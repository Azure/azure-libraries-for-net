...
namespace Microsoft.Azure.Management.ServiceFabric.Fluent.Models
{
    ...
    public partial class NodeTypeDescription
    {
        ...
        /// proxy.</param>
        public NodeTypeDescription(string name, int clientConnectionEndpointPort, int httpGatewayEndpointPort, bool isPrimary, int vmInstanceCount, IDictionary<string, string> placementProperties = default(IDictionary<string, string>), IDictionary<string, string> capacities = default(IDictionary<string, string>), DurabilityLevel durabilityLevel = default(DurabilityLevel), EndpointRangeDescription applicationPorts = default(EndpointRangeDescription), EndpointRangeDescription ephemeralPorts = default(EndpointRangeDescription), int? reverseProxyEndpointPort = default(int?))
        {
            Name = name;
