...
namespace Microsoft.Azure.Management.ServiceFabric.Fluent.Models
{
    ...
    public partial class ServiceLoadMetricDescription
    {
        ...
        /// this metric.</param>
        public ServiceLoadMetricDescription(string name, ServiceLoadMetricWeight weight = default(ServiceLoadMetricWeight), int? primaryDefaultLoad = default(int?), int? secondaryDefaultLoad = default(int?), int? defaultLoad = default(int?))
        {
            Name = name;
            Weight = weight;
