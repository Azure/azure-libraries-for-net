...
namespace Microsoft.Azure.Management.ServiceFabric.Fluent.Models
{
    ...
    public partial class ClusterCodeVersionsResult
    {
        ...
        /// 'Linux'</param>
        public ClusterCodeVersionsResult(string id = default(string), string name = default(string), string type = default(string), string codeVersion = default(string), string supportExpiryUtc = default(string), Environment environment = default(Environment))
        {
            Id = id;
            Name = name;
            Type = type;
