...
namespace Microsoft.Azure.Management.ServiceFabric.Fluent.Models
{
    ...
    public partial class ApplicationResourceInner : Management.ResourceManager.Fluent.Resource
    {
        /// <summary>
        /// Initializes a new instance of the ApplicationResourceInner class.
        /// </summary>
        ...
        public ApplicationResourceInner(string id = default(string), string name = default(string), string type = default(string), string typeVersion = default(string), IDictionary<string, string> parameters = default(IDictionary<string, string>), ApplicationUpgradePolicy upgradePolicy = default(ApplicationUpgradePolicy), long? minimumNodes = default(long?), long? maximumNodes = default(long?), bool? removeApplicationCapacity = default(bool?), IList<ApplicationMetricDescription> metrics = default(IList<ApplicationMetricDescription>), string provisioningState = default(string), string typeName = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string etag = default(string))
            : base(id, name, type)
        {
