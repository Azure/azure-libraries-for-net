...
namespace Microsoft.Azure.Management.ServiceFabric.Fluent.Models
{
    ...
    public partial class ArmRollingUpgradeMonitoringPolicy
    {
        ...
        public ArmRollingUpgradeMonitoringPolicy(ArmUpgradeFailureAction failureAction = default(ArmUpgradeFailureAction), string healthCheckWaitDuration = default(string), string healthCheckStableDuration = default(string), string healthCheckRetryTimeout = default(string), string upgradeTimeout = default(string), string upgradeDomainTimeout = default(string))
        {
