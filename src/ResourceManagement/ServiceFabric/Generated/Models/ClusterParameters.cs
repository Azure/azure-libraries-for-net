...
namespace Microsoft.Azure.Management.ServiceFabric.Fluent.Models
{
    ...
    public partial class ClusterParameters : Management.ResourceManager.Fluent.Resource
    {
        /// <summary>
        /// Initializes a new instance of the ClusterParameters class.
        /// </summary>
        ...
        public ClusterParameters(string location, string managementEndpoint, IList<NodeTypeDescription> nodeTypes, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), IList<AddOnFeatures> addOnFeatures = default(IList<AddOnFeatures>), IList<ClusterVersionDetails> availableClusterVersions = default(IList<ClusterVersionDetails>), AzureActiveDirectory azureActiveDirectory = default(AzureActiveDirectory), CertificateDescription certificate = default(CertificateDescription), ServerCertificateCommonNames certificateCommonNames = default(ServerCertificateCommonNames), IList<ClientCertificateCommonName> clientCertificateCommonNames = default(IList<ClientCertificateCommonName>), IList<ClientCertificateThumbprint> clientCertificateThumbprints = default(IList<ClientCertificateThumbprint>), string clusterCodeVersion = default(string), string clusterEndpoint = default(string), string clusterId = default(string), ClusterState clusterState = default(ClusterState), DiagnosticsStorageAccountConfig diagnosticsStorageAccountConfig = default(DiagnosticsStorageAccountConfig), bool? eventStoreServiceEnabled = default(bool?), IList<SettingsSectionDescription> fabricSettings = default(IList<SettingsSectionDescription>), ProvisioningState provisioningState = default(ProvisioningState), ReliabilityLevel reliabilityLevel = default(ReliabilityLevel), CertificateDescription reverseProxyCertificate = default(CertificateDescription), ServerCertificateCommonNames reverseProxyCertificateCommonNames = default(ServerCertificateCommonNames), ClusterUpgradePolicy upgradeDescription = default(ClusterUpgradePolicy), UpgradeMode upgradeMode = default(UpgradeMode), string vmImage = default(string), string etag = default(string))
        ...
        public IList<AddOnFeatures> AddOnFeatures { get; set; }
