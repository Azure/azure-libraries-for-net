...
namespace Microsoft.Azure.Management.ServiceFabric.Fluent
{
    ...
    public static partial class ApplicationTypesOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<ApplicationTypeResourceInner> GetAsync(this IApplicationTypesOperations operations, string resourceGroupName, string clusterName, string applicationTypeName, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ApplicationTypeResourceInner> CreateOrUpdateAsync(this IApplicationTypesOperations operations, string resourceGroupName, string clusterName, string applicationTypeName, ApplicationTypeResourceInner parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ApplicationTypeResourceListInner> ListAsync(this IApplicationTypesOperations operations, string resourceGroupName, string clusterName, CancellationToken cancellationToken = default(CancellationToken))
            {
