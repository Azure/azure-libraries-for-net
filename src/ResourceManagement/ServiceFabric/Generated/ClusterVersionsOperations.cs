...
namespace Microsoft.Azure.Management.ServiceFabric.Fluent
{
    ...
    internal partial class ClusterVersionsOperations : IServiceOperations<ServiceFabricManagementClient>, IClusterVersionsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ClusterCodeVersionsListResultInner>> GetWithHttpMessagesAsync(string location, string clusterVersion, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (location == null)
            {
            ...
            // Create Result
            var _result = new AzureOperationResponse<ClusterCodeVersionsListResultInner>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ClusterCodeVersionsListResultInner>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<ClusterCodeVersionsListResultInner>> GetByEnvironmentWithHttpMessagesAsync(string location, Environment environment, string clusterVersion, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (location == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "location");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<ClusterCodeVersionsListResultInner>> ListWithHttpMessagesAsync(string location, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (location == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "location");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<ClusterCodeVersionsListResultInner>> ListByEnvironmentWithHttpMessagesAsync(string location, Environment environment, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (location == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "location");
