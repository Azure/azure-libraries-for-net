...
namespace Microsoft.Azure.Management.Storage.Fluent
{
    ...
    internal class StorageNetworkRulesHelper
    {
        ...
        internal static bool IsAccessAllowedFromAllNetworks(StorageAccountInner inner)
        {
            ...
            return inner.NetworkRuleSet.DefaultAction == DefaultAction.Allow;
        }
        ...
        {
            if (inner.NetworkRuleSet != null && inner.NetworkRuleSet.DefaultAction != null && inner.NetworkRuleSet.DefaultAction == DefaultAction.Deny)
            {
