...
namespace Microsoft.Azure.Management.Storage.Fluent
{
    ...
    internal partial class SkusOperations : IServiceOperations<StorageManagementClient>, ISkusOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<SkuInner>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<SkuInner>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<SkuInner>>(_responseContent, Client.DeserializationSettings);
                }
