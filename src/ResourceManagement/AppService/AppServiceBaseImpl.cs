...
namespace Microsoft.Azure.Management.AppService.Fluent
{
        ...
        where UpdateT : class, WebAppBase.Update.IUpdate<FluentT>
    {
        ...
        {
            Stream stream = Extensions.Synchronize(() => Manager.Inner.WebApps.ListPublishingProfileXmlWithSecretsAsync(ResourceGroupName, Name, null));
        ...
        {
            return await Manager.Inner.WebApps.GetWebSiteContainerLogsAsync(ResourceGroupName, Name, cancellationToken);
        }
