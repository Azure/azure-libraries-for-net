...
namespace Microsoft.Azure.Management.AppService.Fluent
{
    ...
    public static partial class DomainsOperationsExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<DomainInner> UpdateAsync(this IDomainsOperations operations, string resourceGroupName, string domainName, DomainPatchResourceInner domain, CancellationToken cancellationToken = default(CancellationToken))
            {
