...
namespace Microsoft.Azure.Management.AppService.Fluent
{
    ...
    public partial interface ICertificatesOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<CertificateInner>> UpdateWithHttpMessagesAsync(string resourceGroupName, string name, CertificatePatchResourceInner certificateEnvelope, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Get all certificates for a subscription.
        /// </summary>
        /// <remarks>
