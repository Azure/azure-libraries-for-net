...
namespace Microsoft.Azure.Management.AppService.Fluent.Models
{
    ...
    public partial class SnapshotRecoveryRequest : ProxyOnlyResourceInner
    {
        /// <summary>
        ...
        /// enabled.</param>
        public SnapshotRecoveryRequest(bool overwrite, string id = default(string), string name = default(string), string type = default(string), string kind = default(string), string snapshotTime = default(string), SnapshotRecoveryTarget recoveryTarget = default(SnapshotRecoveryTarget), bool? recoverConfiguration = default(bool?), bool? ignoreConflictingHostNames = default(bool?))
