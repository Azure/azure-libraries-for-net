...
namespace Microsoft.Azure.Management.AppService.Fluent.Models
{
    ...
    public partial class GlobalCsmSkuDescription
    {
        ...
        public GlobalCsmSkuDescription(string name = default(string), string tier = default(string), string size = default(string), string family = default(string), SkuCapacity capacity = default(SkuCapacity), IList<string> locations = default(IList<string>), IList<CapabilityInner> capabilities = default(IList<CapabilityInner>))
        {
            Name = name;
            Tier = tier;
            Size = size;
