...
namespace Microsoft.Azure.Management.AppService.Fluent.Models
{
    ...
    public partial class AppServiceCertificatePatchResourceInner : ProxyOnlyResource
    {
        /// <summary>
        /// Initializes a new instance of the
        /// AppServiceCertificatePatchResourceInner class.
        /// </summary>
        ...
        /// 'Unknown'</param>
        public AppServiceCertificatePatchResourceInner(string id = default(string), string name = default(string), string kind = default(string), string type = default(string), string keyVaultId = default(string), string keyVaultSecretName = default(string), KeyVaultSecretStatus? provisioningState = default(KeyVaultSecretStatus?))
