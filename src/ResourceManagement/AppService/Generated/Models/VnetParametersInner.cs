...
namespace Microsoft.Azure.Management.AppService.Fluent.Models
{
    ...
    public partial class VnetParametersInner : ProxyOnlyResource
    {
        /// <summary>
        /// Initializes a new instance of the VnetParametersInner class.
        /// </summary>
        public VnetParametersInner()
        {
            CustomInit();
        }
        ...
        /// validated</param>
        public VnetParametersInner(string id = default(string), string name = default(string), string kind = default(string), string type = default(string), string vnetResourceGroup = default(string), string vnetName = default(string), string vnetSubnetName = default(string))
