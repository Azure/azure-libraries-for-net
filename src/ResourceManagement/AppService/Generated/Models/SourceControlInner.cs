...
namespace Microsoft.Azure.Management.AppService.Fluent.Models
{
    ...
    public partial class SourceControlInner : ProxyOnlyResourceInner
    {
        /// <summary>
        ...
        public SourceControlInner(string id = default(string), string name = default(string), string type = default(string), string kind = default(string), string token = default(string), string tokenSecret = default(string), string refreshToken = default(string), System.DateTime? expirationTime = default(System.DateTime?))
