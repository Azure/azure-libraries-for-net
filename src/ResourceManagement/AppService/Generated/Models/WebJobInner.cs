...
namespace Microsoft.Azure.Management.AppService.Fluent.Models
{
    ...
    public partial class WebJobInner : ProxyOnlyResourceInner
    {
        /// <summary>
        ...
        public WebJobInner(string id = default(string), string name = default(string), string type = default(string), string kind = default(string), string runCommand = default(string), string url = default(string), string extraInfoUrl = default(string), WebJobType? webJobType = default(WebJobType?), string error = default(string), bool? usingSdk = default(bool?), IDictionary<string, object> settings = default(IDictionary<string, object>))
