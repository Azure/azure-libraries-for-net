...
namespace Microsoft.Azure.Management.AppService.Fluent.Models
{
    ...
    public partial class StorageMigrationOptionsInner : ProxyOnlyResource
    {
        ...
        /// &lt;code&gt;false&lt;/code&gt;.</param>
        public StorageMigrationOptionsInner(string azurefilesConnectionString, string azurefilesShare, string id = default(string), string name = default(string), string kind = default(string), string type = default(string), bool? switchSiteAfterMigration = default(bool?), bool? blockWriteAccessToSite = default(bool?))
