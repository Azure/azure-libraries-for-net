...
namespace Microsoft.Azure.Management.AppService.Fluent.Models
{
    ...
    public partial class RenewCertificateOrderRequestInner : ProxyOnlyResource
    {
        /// <summary>
        ...
        /// versa).</param>
        public RenewCertificateOrderRequestInner(string id = default(string), string name = default(string), string kind = default(string), string type = default(string), int? keySize = default(int?), string csr = default(string), bool? isPrivateKeyExternal = default(bool?))
