                    ...
                    var setting = azure.AutoscaleSettings
                            ...
                            .DefineAutoscaleProfile("AutoScaleProfile1")
                                ...
                                .DefineScaleRule()
                                    ...
                                    .WithCondition(ComparisonOperationType.GreaterThan, TimeAggregationType.Average, 70)
                            ...
                            .DefineAutoscaleProfile("AutoScaleProfile2")
                                ...
                                .DefineScaleRule()
                                    ...
                                    .WithMetricName("CPUPercentage")
                                    .WithStatistic(TimeSpan.FromMinutes(10), TimeSpan.FromMinutes(1), MetricStatisticType.Average)
                                    .WithCondition(ComparisonOperationType.LessThan, TimeAggregationType.Average, 20)
                    ...
                    setting.Update()
                            ...
                            .DefineAutoscaleProfile("a new profile")
                                ...
                                .DefineScaleRule()
                                    ...
                                    .WithCondition(ComparisonOperationType.LessThan, TimeAggregationType.Total, 6)
                            ...
                            .UpdateAutoscaleProfile("AutoScaleProfile2")
                                ...
                                .DefineScaleRule()
                                    ...
                                    .WithCondition(ComparisonOperationType.LessThan, TimeAggregationType.Total, 50)
