...
namespace Microsoft.Azure.Management.Batch.Fluent.Pool.Update
{
    using Microsoft.Azure.Management.Batch.Fluent.Models;
    using System.Collections.Generic;

    /// <summary>
    /// The stage of a batch pool update.
    /// </summary>
    public interface IWithAttach
    {
        ...
        IUpdate WithNetworkConfiguration(NetworkConfiguration networkConfiguration);
        ...
        /// <return>The next stage of the update.</return>
        IUpdate WithScaleSettings(ScaleSettings scaleSettings);
        ...
        /// <return>The next stage of the update.</return>
        IUpdate WithStartTask(StartTask startTask);
        ...
        /// <return>The next stage of the update.</return>
        IUpdate WithMetadata(IList<MetadataItem> metadata);
        ...
        /// <return>The next stage of the update.</return>
        IUpdate WithApplicationPackages(IList<ApplicationPackageReference> applicationPackages);
        ...
        /// <return>The next stage of the update.</return>
        IUpdate WithCertificates(IList<CertificateReference> certificates);
        ...
        /// <return>The next stage of the update.</return>
        IUpdate WithVmSize(string vmSize);
        ...
        /// <return>The next stage of the update.</return>
        IUpdate WithDeploymentConfiguration(DeploymentConfiguration deploymentConfiguration);
        ...
        /// <return>The next stage of the update.</return>
        IUpdate WithInterNodeCommunication(InterNodeCommunicationState interNodeCommunication);
        ...
        /// <return>The next stage of the update.</return>
        IUpdate WithMaxTasksPerNode(int? maxTasksPerNode);
        ...
        /// <return>The next stage of the update.</return>
        IUpdate WithTaskSchedulingPolicy(TaskSchedulingPolicy taskSchedulingPolicy);
        ...
        /// <return>The next stage of the update.</return>
        IUpdate WithUserAccount(IList<UserAccount> userAccounts);
        ...
        /// <return>The next stage of the update.</return>
        IUpdate WithApplicationLicenses(IList<string> applicationLicenses);
    }
    ...
    public interface IUpdate :
        ResourceManager.Fluent.Core.ChildResourceActions.ISettable<BatchAccount.Update.IUpdate>,
        IWithAttach
    {
    }
}
