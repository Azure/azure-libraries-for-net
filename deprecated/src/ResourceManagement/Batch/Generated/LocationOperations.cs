...
namespace Microsoft.Azure.Management.Batch.Fluent
{
    ...
    internal partial class LocationOperations : IServiceOperations<BatchManagementClient>, ILocationOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<BatchLocationQuotaInner>> GetQuotasWithHttpMessagesAsync(string locationName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<BatchLocationQuotaInner>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<BatchLocationQuotaInner>(_responseContent, Client.DeserializationSettings);
                }
